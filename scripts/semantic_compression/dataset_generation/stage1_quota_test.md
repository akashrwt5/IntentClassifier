...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 180 | 0.838 | 0.915 | +0.077 |

**Mean gain across intents: +0.077**
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 180 | 106 → 23 → 26 → 8 | 36% | saturated — budget is enough |
...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 2.2% | 77.3% | 8.1 | 3.1 |

## 3. Type and difficulty mix

| Type | count | share |
|---|---:|---:|
| ExplicitCommand | 83 | 46.1% |
| ObservationPlusCommand | 71 | 39.4% |
| ImplicitCommand | 26 | 14.4% |

**Indirect share (Implicit + ObservationPlusCommand): 53.9%**
...
|---|---:|---|---|---:|
| Medium | 46.7% |   | LLM-Generated | 82.2% |
| Hard | 32.2% |   | ASR-Simulated | 17.8% |
| Easy | 21.1% |   |  |  |
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 2.2% | `Help_InsertDevice` | 5.0% | `Help_Volume` |

## 5. Rejections

3 rejected batches. Most common causes:

- labelled ImplicitCommand but states no need and requests not — ×2
- duplicates an utterance already accepted — ×1
