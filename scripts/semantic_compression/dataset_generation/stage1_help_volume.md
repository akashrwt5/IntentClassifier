...
|---|---:|---:|---:|
| `Help_Volume` | 120 | 120 | 100% |

## 0b. Quota compliance

**`Help_Volume`** — the prompt states these as counts per batch; the
targets below are scaled to the 120 rows produced.

| constraint | asked | got | |
|---|---|---:|---|
| difficulty Easy | ~42 | 52 |  **OFF** |
| difficulty Medium | ~48 | 55 | |
| difficulty Hard | ~30 | 13 |  **OFF** |
...
|---|---:|---:|---:|---:|
| `Help_Volume` | 120 | 0.654 | 0.872 | +0.218 |

**Mean gain across intents: +0.218**
...
|---|---:|---|---:|---|
| `Help_Volume` | 120 | 147 → 69 → 48 → 39 | 13% | levelling off |
...
|---|---:|---:|
| Question | 118 | 98.3% |
| ObservationPlusCommand | 2 | 1.7% |

**Indirect share (Implicit + ObservationPlusCommand): 1.7%**
...
|---|---:|---|---|---:|
| Medium | 45.8% |   | LLM-Generated | 97.5% |
| Easy | 43.3% |   | ASR-Simulated | 2.5% |
| Hard | 10.8% |   |  |  |
...
|---|---:|---|---:|---|
| `Help_Volume` | 3.3% | `Help_SelfCheck` | 39.2% | `Cmd.VolumeDecrease` |

## 5. Rejections

11 rejected batches. Most common causes:

- 21 words exceeds the 20-word limit for type Question — ×9
- 23 words exceeds the 20-word limit for type Question — ×8
- duplicates an utterance already accepted — ×4
- intent is 'ImplicitCommand', must be 'Cmd.VolumeIncrease' — ×3
- 25 words exceeds the 20-word limit for type Question — ×3
- 22 words exceeds the 20-word limit for type Question — ×3
- 26 words exceeds the 20-word limit for type Question — ×3
