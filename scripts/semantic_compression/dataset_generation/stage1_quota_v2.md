...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 180 | 0.838 | 0.921 | +0.082 |

**Mean gain across intents: +0.082**
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 180 | 87 → 31 → 16 → 7 | 40% | saturated — budget is enough |
...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 8.3% | 73.0% | 7.2 | 3.4 |

## 3. Type and difficulty mix

| Type | count | share |
|---|---:|---:|
| ObservationPlusCommand | 86 | 47.8% |
| ExplicitCommand | 71 | 39.4% |
| ImplicitCommand | 23 | 12.8% |

**Indirect share (Implicit + ObservationPlusCommand): 60.6%**
...
|---|---:|---|---|---:|
| Medium | 41.1% |   | LLM-Generated | 86.1% |
| Hard | 30.0% |   | ASR-Simulated | 13.9% |
| Easy | 28.9% |   |  |  |
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 1.7% | `Help_SelfCheck` | 6.1% | `Help_Volume` |

## 5. Rejections

6 rejected batches. Most common causes:

- duplicates an utterance already accepted — ×6
- labelled ImplicitCommand but states no need and requests not — ×3
- intent is 'ImplicitCommand', must be 'Cmd.VolumeIncrease' — ×2
