...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 180 | 0.838 | 0.898 | +0.060 |

**Mean gain across intents: +0.060**
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 180 | 113 → 28 → 28 → 31 | 31% | levelling off |
...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 3.9% | 80.5% | 10.1 | 2.4 |

## 3. Type and difficulty mix

| Type | count | share |
|---|---:|---:|
| ObservationPlusCommand | 99 | 55.0% |
| ExplicitCommand | 64 | 35.6% |
| ImplicitCommand | 17 | 9.4% |

**Indirect share (Implicit + ObservationPlusCommand): 64.4%**
...
|---|---:|---|---|---:|
| Medium | 40.0% |   | LLM-Generated | 82.8% |
| Hard | 39.4% |   | ASR-Simulated | 17.2% |
| Easy | 20.6% |   |  |  |
...
(similarity below 0.65). This is real drift: an utterance
about batteries filed under a volume intent is a defect, and these
are the samples most likely to become false accepts. Act on these.
...
| Intent | FAR (act) | into | NEAR (noise) | into |
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 1.7% | `Help_Tinnitus` | 12.2% | `Help_Volume` |
