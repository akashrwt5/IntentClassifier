...
57 intents, 18 families. 53 intent pairs claim overlapping ground; 53 of those name each other explicitly.
...
**`Default Fallback Intent`** — similarity 0.33
...
**`Help_ChangingMemories`** — similarity 0.22

- TRIGGER: User asks whether they have a particular memory available.
- DO NOT: Reports that an expected memory is MISSING from the list, which are Help_MemoryOptions. Asking whether a memory is available is a step towards switch…
...
| HelpHealth | 3 | ☑ | Akash Rawat | 2026-08-30 |
