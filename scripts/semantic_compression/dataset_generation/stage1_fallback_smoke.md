...
|---|---:|---:|---:|
| `Default Fallback Intent` | 50 | 800 | 6%  ⚠ |
...
targets below are scaled to the 50 rows produced.
...
|---|---:|---:|---:|---:|
| `Default Fallback Intent` | 50 | 0.969 | 0.956 | -0.013  ⚠ |

**Mean gain across intents: -0.013**
...
|---|---:|---|---:|---|
| `Default Fallback Intent` | 50 | 74 → 66 → 40 → 39 | 0% | **still climbing — raise budget** |
...
|---|---:|---:|---:|---:|
| `Default Fallback Intent` | 0.0% | 32.4% | 9.7 | 3.3 |
...
|---|---:|---:|
| Observation | 20 | 40.0% |
| Conversation | 13 | 26.0% |
| ExplicitCommand | 8 | 16.0% |
| Question | 5 | 10.0% |
| Negation | 4 | 8.0% |
...
|---|---:|---|---|---:|
| Medium | 40.0% |   | LLM-Generated | 94.0% |
| Easy | 36.0% |   | ASR-Simulated | 6.0% |
| Hard | 24.0% |   |  |  |
...
|---|---:|---|---:|---|
| `Default Fallback Intent` | 56.0% | `Cmd.VolumeIncrease` | 2.0% | `Cmd.VolumeUnmute` |
