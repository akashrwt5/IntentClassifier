...
|---|---:|---:|---:|
| `Cmd.VolumeIncrease` | 180 | 180 | 100% |

## 0b. Quota compliance

**`Cmd.VolumeIncrease`** — the prompt states these as counts per batch; the
targets below are scaled to the 180 rows produced.

| constraint | asked | got | |
|---|---|---:|---|
| <= 4 words | min 50 | 50 | |
| ExplicitCommand | min 72 | 87 | |
| ImplicitCommand | min 22 | 25 | |
| ObservationPlusCommand | 36-50 | 68 |  **OVER** |
| ASR-Simulated | 22-36 | 25 | |
| difficulty Easy | ~63 | 42 |  **OFF** |
| difficulty Medium | ~72 | 85 | |
| difficulty Hard | ~45 | 53 | |
...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 180 | 0.838 | 0.923 | +0.085 |

**Mean gain across intents: +0.085**
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 180 | 98 → 13 → 16 → 8 | 60% | saturated — budget is enough |
...
|---|---:|---:|---:|---:|
| `Cmd.VolumeIncrease` | 8.3% | 71.1% | 6.3 | 2.5 |

## 3. Type and difficulty mix

| Type | count | share |
|---|---:|---:|
| ExplicitCommand | 87 | 48.3% |
| ObservationPlusCommand | 68 | 37.8% |
| ImplicitCommand | 25 | 13.9% |

**Indirect share (Implicit + ObservationPlusCommand): 51.7%**
...
|---|---:|---|---|---:|
| Medium | 47.2% |   | LLM-Generated | 86.1% |
| Hard | 29.4% |   | ASR-Simulated | 13.9% |
| Easy | 23.3% |   |  |  |
...
|---|---:|---|---:|---|
| `Cmd.VolumeIncrease` | 2.2% | `Cmd.EdgeModeIncrease` | 6.1% | `Cmd.VolumeUnmute` |

## 5. Rejections

5 rejected batches. Most common causes:
