...
|---|---|---:|---|
| <= 7 words | min 34 | 30 |  **UNDER** |
| Question | min 106 | 120 | |
| ASR-Simulated | 10-19 | 12 | |
| difficulty Easy | ~42 | 31 |  **OFF** |
| difficulty Medium | ~48 | 56 | |
| difficulty Hard | ~30 | 33 | |
...
|---|---:|---|---:|---|
| `Help_Volume` | 120 | 137 → 51 → 58 → 43 | 13% | levelling off |
...
|---|---:|---|---|---:|
| Medium | 46.7% |   | LLM-Generated | 90.0% |
| Hard | 27.5% |   | ASR-Simulated | 10.0% |
| Easy | 25.8% |   |  |  |
...
|---|---:|---|---:|---|
| `Help_Volume` | 5.8% | `Help_FindMyHearingAids` | 50.0% | `Cmd.VolumeDecrease` |

## 5. Rejections

8 rejected batches. Most common causes:
