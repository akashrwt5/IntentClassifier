...
widget:
- source_sentence: can you please turn off the volume on my left aid
  sentences:
  - hey, turn up the volume on both hearing aids
  - i want you to cut the stream from my meeting audio
  - raise both my aids
- source_sentence: please stop the stream coming from my meeting audio
  sentences:
  - i'd like to understand how do reminders work
  - can you please stop all sound on my right aid
  - explain how to rename the reminder feature
- source_sentence: please end the connection to my laptop
  sentences:
  - i need to knock down the volume on my hearing aid
  - change to auditorium program
  - i need to turn the volume all the way down on my right ear hearing aid
- source_sentence: please set to office memory
  sentences:
  - can you change program to crowd
  - let's turn the volume back on for my left aid
  - i need help, locate my cellphone in the living room
- source_sentence: how can i duplicate an alarm
  sentences:
  - can you set memory to car
  - explain how to set up my reminder settings
  - boost the volume on my right aid
...
print(similarities)
# tensor([[ 1.0000, -0.6232,  0.9997],
#         [-0.6232,  1.0000, -0.6274],
#         [ 0.9997, -0.6274,  1.0000]])
```
<!--
...
* Approximate statistics based on the first 100 samples:
  ...
  | type     | string                                                                            | int                                                                                                                                                                                                                   |
  | modality | text                                                                              |                                                                                                                                                                                                                       |
  | details  | <ul><li>min: 5 tokens</li><li>mean: 11.21 tokens</li><li>max: 18 tokens</li></ul> | <ul><li>0: ~5.77%</li><li>1: ~3.85%</li><li>2: ~14.42%</li><li>3: ~11.54%</li><li>4: ~12.50%</li><li>5: ~12.50%</li><li>6: ~5.77%</li><li>7: ~7.69%</li><li>8: ~8.65%</li><li>9: ~6.73%</li><li>10: ~10.58%</li></ul> |
* Samples:
  | sentence_0                                                        | label          |
  |:------------------------------------------------------------------|:---------------|
  | <code>could you remind me to call my friend in 20 minutes</code>  | <code>8</code> |
  | <code>hey, turn the volume back on for my left hearing aid</code> | <code>4</code> |
  | <code>could you take my device off mute</code>                    | <code>4</code> |
