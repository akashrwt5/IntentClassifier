...
MODEL_NAME = "MODEL C — LARGER STUDENT"
OUT_DIR = os.path.join(SCRIPT_DIR, "tiny_semantic_student_model_c")
...
out.to_csv(os.path.join(SCRIPT_DIR, "model_c_unseen_predictions.csv"), index=False)
out[~out["correct"]].to_csv(os.path.join(SCRIPT_DIR, "model_c_unseen_errors.csv"), index=False)

print("\nSaved model:", os.path.join(OUT_DIR, "student_fp32.pt"))
print("Unseen predictions:", "model_c_unseen_predictions.csv")
print("Unseen errors:", "model_c_unseen_errors.csv")
