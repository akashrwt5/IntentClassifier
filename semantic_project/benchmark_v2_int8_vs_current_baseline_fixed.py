...
class ONNXIntentModel:
    ...
    def predict(self, texts):
        ...
        # V2 INT8 was exported with static batch=1 for reliable
        # ONNX Runtime execution. Therefore, run one sentence at
        # a time and concatenate the results. This also works for
        # the Current INT8 model if it supports larger batches.
        predictions = []
        confidences = []
