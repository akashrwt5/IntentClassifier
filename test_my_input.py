...
def main():
    ...
    print("\n" + "=" * 60)
    print("🎯 NLU Reminder Tester (Multiple Phrases Mode)")
    print("   Editor ke console me apna sentence likhein aur Enter dabayein.")
    print("   Band karne ke liye 'exit' ya 'quit' likhein.")
    print("=" * 60)
    ...
    while True:
        ...
        # Har input ko independent session me test karte hain taaki previous slots interfere na karein
